...
def getData():
    with open('config.json') as json_file:
        flask.g.data = json.load(json_file)
        print flask.g.data["schedules"]
...
def main():
    ...
    templateData = { 'zones': flask.g.data['zones'], 'schedules': flask.g.data["schedules"] }
    return flask.render_template('main.html', **templateData)
